...
eval dfx canister --network ic install icpunks --argument="'(\"Crypto4Meadows\", \"C4M\", 10000, $PUBLIC_KEY)'" -m reinstall
...
eval dfx canister --network ic call icpunks set_owner "'(principal \"wgkgu-x3efg-isqui-eycha-nxyr2-7eydm-xso43-a7lx2-2tlid-felwc-eqe\")'"
